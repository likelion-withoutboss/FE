...
export default function About() {
  ...
  const renderCurriculum = (category) => (
    <div className="bg-white rounded-lg shadow-xl p-4 md:p-8 mx-auto max-w-2xl">
      ...
      />
      <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-800 mb-2">{curriculumData[category].title}</h2>
      <p className="text-gray-700 text-base md:text-lg leading-relaxed">{curriculumData[category].description}</p>
    </div>
  );
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
      ...
      <div className="flex flex-wrap justify-center gap-4 mb-8"> {/* 버튼 그룹 */}
